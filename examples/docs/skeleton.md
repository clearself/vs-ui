...
<div class="demo-block">
  <vs-row>
    <vs-col :span="4">
      <vs-skeleton></vs-skeleton>
    </vs-col>
    <vs-col :span="4" class="ml-10">
      <vs-row>
        <vs-col :span="12">
          <vs-skeleton :proportion="0.2"></vs-skeleton>
        </vs-col>
        <vs-col :span="24" class="m-10">
          <vs-skeleton :proportion="0.1"></vs-skeleton>
        </vs-col>
        <vs-col :span="24" class="m-10">
          <vs-skeleton :proportion="0.1"></vs-skeleton>
        </vs-col>
...
<template>
  <div class="main-skeleton">
    <vs-skeleton height="80px"></vs-skeleton>
    <div>
      <div class="skeleton-container">
        <div class="skeleton">
          <vs-skeleton height="300px"></vs-skeleton>
        </div>
        <vs-skeleton height="45px"></vs-skeleton>
      </div>
