...
<div class="demo-block">
   <vs-button @click="start">开始</vs-button>
   <vs-button @click="end">结束</vs-button>
   <vs-button @click="error">错误</vs-button>
</div>
...
<div class="demo-block">
   <vs-button @click="setSpeed">设置speed速度</vs-button>
   <vs-button @click="setSpinner">设置spinner动画效果</vs-button>
   <vs-button @click="setPercentNum">设置percentNum每次加载的比例</vs-button>
   <vs-button @click="setShowSpinner">设置是否显示spinner</vs-button>
</div>
